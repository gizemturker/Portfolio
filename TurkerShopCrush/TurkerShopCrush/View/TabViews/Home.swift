...
//  TurkerShopCrush
//
//  Created by Gizem Turker on 8.05.2023.
//
    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: false) {
            ...
            VStack(spacing: 15){
                ...
                // see more button
                // the button show all products on the current product types
                // since here were shopping only 4
        ...
        .onTapGesture {
            ...
            func ProductTypeView(type: ProductType)->some View {
                ...
                Button {
                    ...
                    // Changing color based on surrent product type
                        .foregroundColor(homeData.productType == type ? Color("Pink") : Color.gray)
                        .padding(.bottom,10)
